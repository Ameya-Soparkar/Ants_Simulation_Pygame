...
class Food:
    ...
    def move(self):
        ...
        self.x += self.dx * FOOD_SPEED

        self.y += self.dy * FOOD_SPEED
...
while running:
    ...
    for ant in ants:
        ...
        nearest_food = ant.get_nearest_food(
